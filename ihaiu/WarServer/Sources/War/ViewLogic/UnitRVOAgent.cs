...
namespace Games.Wars
{
    ...
    public class UnitRVOAgent : AbstractUnitMonoBehaviour
    {
        public UnitSpaceType spaceType = UnitSpaceType.Fly;
        ...
        public Quaternion rotationQuaternion
        {
            ...
            get
            {
                return AnchorRotation.rotation;
            }

            set
            {

                AnchorRotation.rotation = value;
            }
        }
        ...
        public void RecalculatePath()
        {
            ...
            nextRepath = Time.time + repathRate * (0.5f);
            seeker.StartPath(transform.position, target, OnPathComplete, spaceType.GetPathGraphMask());
        }
        ...
        private void Update()
        {
            ...
            if (vectorPath != null && vectorPath.Count != 0 && (wp >= 0 && wp < vectorPath.Count))
            {
            ...
            if (Time.deltaTime > 0 && movementDelta.magnitude / Time.deltaTime > 0.01f)
            {
                ...
                rotationQuaternion = Quaternion.Slerp(rot, targetRot, Time.deltaTime * RotationSpeed);
            }
            ...
            if (controller.movementPlane == MovementPlane.XZ)
            {
                ...
                NNInfo info = AstarPath.active.GetNearest(pos, spaceType.GetNNConstraint());
                pos = info.position;
            }
