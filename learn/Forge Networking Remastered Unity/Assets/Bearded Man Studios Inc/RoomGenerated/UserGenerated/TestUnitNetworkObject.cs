...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class TestUnitNetworkObject : NetworkObject
	{
		...
		public TestUnitNetworkObject() : base() { Initialize(); }
		public TestUnitNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public TestUnitNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
